...
jQuery(document).ready(function($) {
    $('#collections').addFlickrCollections({"user_id":"66052014@N08",api_key: "bab05ea17002c5f9f458a145df6ff286"});
    flickr.setOptions({
        max: 100,
        thumbSize: 'small',
    ...
    $('#collections a').live('click', function(event) {
      $("#gallery").html("");
      flickr.set(this.hash.slice(1), function(data) {
          console.log(data);
